...
def segment_image(
    ...
    if model_path is None:
        ...
        model_path = script_dir.parent / "models" / "best_quality_unet.pt"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run the final AFM U-Net on one image.")
    parser.add_argument("image_path", type=Path)
    parser.add_argument(
        "--model-path",
        type=Path,
        default=repo_root / "models" / "best_quality_unet.pt",
    )
    parser.add_argument("--output-dir", type=Path, default=Path("segmentation_output"))
