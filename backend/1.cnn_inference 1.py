...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run the final AFM CNN on one image.")
    parser.add_argument("image_path", type=Path)
    parser.add_argument(
        "--model-path",
        type=Path,
        default=repo_root / "models" / "cnn_rgb_classifier.pth",
    )
    ...
    model = load_model(args.model_path, in_channels=3, device=resolved_device)
