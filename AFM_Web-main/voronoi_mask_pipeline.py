...
if __name__ == "__main__":
    MASK_PATH = "/home/newuser/Downloads/mask_A_AC.png"

    out = run_voronoi_analysis(MASK_PATH)
    print("\n=== Dot Extraction ===")
    print(out.get("dot_extraction_stats"))
    print(f"DOTS_ONLY image: {out.get('dots_mask_path')}")

    print("\n=== Voronoi Outputs ===")
    print(f"Voronoi dir: {out.get('voronoi_dir')}")
    print("Selected images:")
    for k, v in (out.get("selected_images") or {}).items():
        print(f"  {k}: {v}")